...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "धीरज पांडेय — शाहपुर घराना | भक्ति संगीत" },
      { property: "og:description", content: "10+ वर्षों का अनुभव, 1000+ कार्यक्रम। बिहार के सभी जिलों में बुकिंग उपलब्ध।" },
